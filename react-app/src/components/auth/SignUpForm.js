    ...
    return (
            <div>
                ...
                <Dialog open={open} style={{width:"100%"}}  aria-labelledby="form-dialog-title">
                    <div>
                         <img src='https://Motoradsappacademy.s3.amazonaws.com/bike.jpg' className={classes.img}></img>
                        <Typography component="h6" variant="h6" align="center" color="primary" style={{marginTop: "20px", fontWeight:"bold"}}>Create Your MotoRads Account
                        </Typography>
                    </div>
